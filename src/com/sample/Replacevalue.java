...
public class Replacevalue {
	 ...
	 * be replaced by 0s
	 * 
	 * For example:given the input list[0 1 2] the function will modify the input
	 * just like [1 1 1]
	 * 
	 * The funcyion/method replaceValues accepts two arguments -size,an integer
	 * representing the size of the given input list and inputList, a list of
	 * integers representing the input list.
	 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub

		int a[] = { 0, 1, 2 ,1,4,8,7,6,1};
//		int a[] = { 0, 1, 2 };
		//int a[] = { 0, 2, 4 };
		//int a[] = { 0, 2, 4,1 };
		int l = a.length;
